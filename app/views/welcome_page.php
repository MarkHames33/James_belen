...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { background: #f3f6fa; color: #18324a; font-family: 'DM Sans', sans-serif; }
        body::before, body::after, .orb { display: none; }
        nav { background: #fff; border-bottom: 1px solid #dce5ed; backdrop-filter: none; }
        .nav-logo { color: #18324a; }
        .nav-logo .flame { background: #0f766e; box-shadow: none; }
        .nav-links a { color: #66788a; }
        .nav-links a:hover { color: #18324a; background: #f3f6fa; }
        .nav-links .btn-nav, .btn-primary { background: #0f766e; }
        .nav-links .btn-nav:hover, .btn-primary:hover { background: #0b5f59; box-shadow: none; }
        .hero h1, .section-title { color: #18324a; }
        .hero h1 .word-lava { color: #0f766e; }
        .hero h1 .word-lust { -webkit-text-stroke-color: #91a2b2; }
        .hero-sub, .section-desc, .stat-label, .feature p { color: #66788a; }
        .badge, .section-label { color: #0f766e; }
        .badge { background: #e7f5f2; border-color: #bde3dc; }
        .badge::before { background: #0f766e; box-shadow: none; }
        .stats { border-color: #dce5ed; }
        .stat-value { color: #18324a; }
        .stat-value span { color: #0f766e; }
        .features-layout { background: #dce5ed; border-color: #dce5ed; }
        .feature { background: #fff; }
        .feature:hover { background: #f8fafc; }
        .feature-icon { background: #e7f5f2; border-color: #bde3dc; }
        .code-block { background: #18324a; border-color: #29445d; }
        footer { background: #18324a; }
